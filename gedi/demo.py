...
pcd0 = o3d.io.read_point_cloud('../object_0_0.ply')
pcd1 = o3d.io.read_point_cloud('../object_0_1.ply')
...
patches0 = min(patches_per_pair, num_points_pcd0)
patches1 = min(patches_per_pair, num_points_pcd1)
...
print("Transformation is: ", est_result01.transformation)
o3d.visualization.draw_geometries([pcd0, pcd1])
